...
static STK_T _kernel_stack_MAIN_TASK[COUNT_STK_T(4096)];
const TINIB _kernel_tinib_table[TNUM_TSKID] = {
	...
	{ (TA_ACT), (EXINF)(0), (TASK)(main_task), INT_PRIORITY(1), {	(void *)(_kernel_stack_MAIN_TASK), 	((void *)((char *)(_kernel_stack_MAIN_TASK) + (ROUND_STK_T(4096)))), }, }
};

TCB _kernel_tcb_table[TNUM_TSKID];

const ID _kernel_torder_table[TNUM_TSKID] = { 
	TSKID_tTask_LogTask_Task, MAIN_TASK
};
